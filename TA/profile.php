...
<br>
			...
			<div class="col-md-8">
				<table class="table">
					...
					<tr>
						<th>Nama </th>
						<td><?php echo $tiap_pelanggan ['nama_pelanggan'] ?></td>
						</tr>
					<tr>
						<th>Email </th>
						<td><?php echo $tiap_pelanggan ['email_pelanggan'] ?></td>
					</tr>
					<tr>
						<th>Password</th>
						<td><input type="Password" name=""  readonly value="<?php echo $tiap_pelanggan['password_pelanggan']  ?>"  class="form-control"></td>
					</tr>
					<tr>
						<th>Telepon</th>
						<td><?php echo $tiap_pelanggan['telepon_pelanggan'] ?></td>
					</tr>
				</table>
				<a href="edit_profile.php?id=<?php echo $tiap_pelanggan['id_pelanggan'] ?>" class="btn btn-warning">Edit</a>
			</div>
		</div>	
	</body>
	</html>
